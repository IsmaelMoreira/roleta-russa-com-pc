...
tk.Label(janela, text="Caminho da Pasta:").grid(row=0, column=0, padx=10, pady=10)
entrada_pasta = tk.Entry(janela, width=50)
entrada_pasta.grid(row=0, column=1, padx=10, pady=10)
btn_selecionar_pasta = tk.Button(janela, text="Selecionar Pasta", command=selecionar_pasta)
btn_selecionar_pasta.grid(row=0, column=2, padx=10, pady=10)

tk.Label(janela, text="Digite um número (1 a 6):").grid(row=1, column=0, padx=10, pady=10)
entrada_numero = tk.Entry(janela, width=10)
entrada_numero.grid(row=1, column=1, padx=10, pady=10)

btn_roleta_russa = tk.Button(janela, text="Rodar Roleta Russa", command=iniciar_roleta)
btn_roleta_russa.grid(row=2, columnspan=3, pady=20)

label_animacao = tk.Label(janela, text="", font=("Helvetica", 32))
